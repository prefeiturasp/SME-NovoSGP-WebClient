...
Background
  ...
  Esquema do Cenário: Validar login para o cenário "<cenario>" 
    ...
    |          | Sgp@1234 | web    | Você precisa informar um usuário e senha para acessar o sistema. | Usuario em branco        |
    | 0720610  |          | web    | Você precisa informar um usuário e senha para acessar o sistema. | Senha em branco          |
    | 1111     | Sgp@1234 | web    | O usuário deve conter no mínimo 5 caracteres.              | Usuario menor que 5 caracteres |
