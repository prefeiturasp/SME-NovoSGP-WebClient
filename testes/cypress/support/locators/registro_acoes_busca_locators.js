class Registro_Acoes_Busca_SGP_Localizadores {
  ...
  mes_inicio_registro_acoes_busca = () => '.ant-picker-cell-inner:eq(1)';
  ano_registro_acoes_busca = () => '.ant-picker-year-btn';
  ano_inicio_registro_acoes_busca = () => '.ant-picker-cell-inner:eq(5)';
  ...
  ano_letivo_registro_acoes_busca = () => 'input[id="SGP_SELECT_ANO_LETIVO"]';
}
