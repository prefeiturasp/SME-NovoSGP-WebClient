...
Cypress.Commands.add('buscar_supervisor_dre_lista_vinculo_responsavel', () => {
    return cy.gerar_token().then((token) => {        
        return cy.request({
          method: 'GET',
...
Cypress.Commands.add('buscar_supervisor_dre_ue_lista_vinculo_responsavel', () => {
    return cy.gerar_token().then((token) => {        
        return cy.request({
          method: 'GET',
...
Cypress.Commands.add('buscar_supervisor_dre_ue_responsavel_lista_vinculo', () => {
    return cy.gerar_token().then((token) => {        
        return cy.request({
          method: 'GET',
...
Cypress.Commands.add('buscar_supervisor_dre_ue_lista_vinculo_sem_responsavel', () => {
    return cy.gerar_token().then((token) => {        
        return cy.request({
          method: 'GET',
...
Cypress.Commands.add('buscar_supervisor_sem_dre_ue_lista_vinculo', () => {
    return cy.gerar_token().then((token) => {        
        return cy.request({
          method: 'GET',
...
Cypress.Commands.add('nao_autorizado_buscar_supervisor_lista_vinculo_responsavel', () => {
    return cy.request({
        method: 'GET',
        url: Cypress.config('baseUrl') + `/api/v1/supervisores/vinculo-lista?DreCodigo=${Cypress.env('DRE_CODIGO')}`,
        headers: {
