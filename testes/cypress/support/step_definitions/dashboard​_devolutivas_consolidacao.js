...
Then('retorna o status 200 com os dados da consolidação', function () {
...
Then('retorna o status 401 sem buscar dados da consolidação', function () {
  cy.get('@response').then((response) => {
