...
Dado(
  'que eu acesso o sistema com a visualização {string} para registro de ações',
  function (device) {
    cy.login_sgp(device);
  },
);
...
Quando(
  'informo os dados nos campos {string} e {string} para registro de ações',
...
Quando('seleciono o ano letivo', function () {
  cy.selecionar_ano_letivo_registro_acoes_busca();
});
