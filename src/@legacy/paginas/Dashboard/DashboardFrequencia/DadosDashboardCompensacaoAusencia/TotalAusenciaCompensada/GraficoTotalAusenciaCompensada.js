...
const GraficoTotalAusenciaCompensada = ({
  anoLetivo,
  dreId,
  ueId,
  modalidade,
    ...
    <>
      <div className="col-12 p-0">
        <div className="row">
          ...
          {dadosGrafico?.tagTotalCompensacaoAusencia && (
            <div className="col-9 mb-2">
              <TagGrafico valor={dadosGrafico?.tagTotalCompensacaoAusencia} />
            </div>
          )}
        </div>
      </div>
...
GraficoTotalAusenciaCompensada.propTypes = {
...
GraficoTotalAusenciaCompensada.defaultProps = {
  anoLetivo: null,
  dreId: null,
  ueId: null,
  modalidade: null,
...
export default comDefaultProps(GraficoTotalAusenciaCompensada, GraficoTotalAusenciaCompensada.defaultProps);