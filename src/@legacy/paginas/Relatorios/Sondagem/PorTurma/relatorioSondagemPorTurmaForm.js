...
const RelatorioSondagemConsolidadoForm = props => {
...
RelatorioSondagemConsolidadoForm.propTypes = {
  onChangeCampos: PropTypes.func,
  form: PropTypes.oneOfType([PropTypes.any]),
};

RelatorioSondagemConsolidadoForm.defaultProps = {
  form: null,
  onChangeCampos: () => null,
};

export default RelatorioSondagemConsolidadoForm;
