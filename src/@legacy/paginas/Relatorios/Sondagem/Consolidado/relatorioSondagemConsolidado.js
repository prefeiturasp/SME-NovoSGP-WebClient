...
import RelatorioSondagemConsolidadoBotoesAcoes from './relatorioSondagemConsolidadoBotoesAcoes';
import RelatorioSondagemConsolidadoForm from './relatorioSondagemConsolidadoForm';

const RelatorioSondagemConsolidado = () => {
    ...
    <Loader loading={gerandoRelatorio}>
      {initialValues ? (
        ...
        >
          {form => (
            <>
              <Cabecalho pagina="Sondagem consolidado">
                <RelatorioSondagemConsolidadoBotoesAcoes
                  form={form}
                  initialValues={initialValues}
              ...
              <Card padding="24px 24px">
                <RelatorioSondagemConsolidadoForm
                  form={form}
...
export default RelatorioSondagemConsolidado;
