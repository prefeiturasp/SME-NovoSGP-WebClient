...
type ItineranciaNAAPADownloadViewFileProps = {
  arquivo: any;
};
const ItineranciaNAAPADownloadViewFile: React.FC<ItineranciaNAAPADownloadViewFileProps> = ({
  arquivo,
}) => {
...
export default ItineranciaNAAPADownloadViewFile;
