      ...
      <Row gutter={[16, 16]} style={{ width: '100%', margin: 0 }}>
        <Col>
          <p style={{ padding: '8px 8px' }}>
            O instrumento de acompanhamento multidisciplinar tem como objetivo
            de historicizar, orientar o planejamento, o monitoramento e a
            avaliação das ações de apoio e acompanhamento ao bebê, à criança e
            ao adolescente, buscando envolver as equipes das Unidades
            Educacionais na elaboração de estratégias que visem enfrentar os
            impactos da vulnerabilidade educacional.
          </p>
        </Col>
      </Row>
      <Row gutter={[16, 16]} style={{ width: '100%', margin: 0 }}>
