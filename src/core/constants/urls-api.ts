export const URL_API_REGISTRO_COLETIVO = 'v1/registro-coletivo';
export const URL_API_FECHAMENTOS_TURMAS = 'v1/fechamentos/turmas';
export const URL_API_FREQUENCIA = 'v1/calendarios';
