...
const GraficoTotalRegistrosIndividuaisPorDRE = props => {
  ...
  const obterDadosGrafico = useCallback(async () => {
    ...
    const retorno = await ServicoDashboardRegistroIndividual.obterTotalRegistrosIndividuaisPorDRE(
      anoLetivo,
...
GraficoTotalRegistrosIndividuaisPorDRE.propTypes = {
...
GraficoTotalRegistrosIndividuaisPorDRE.defaultProps = {
  anoLetivo: null,
  dreId: null,
  ueId: null,
  modalidade: null,
