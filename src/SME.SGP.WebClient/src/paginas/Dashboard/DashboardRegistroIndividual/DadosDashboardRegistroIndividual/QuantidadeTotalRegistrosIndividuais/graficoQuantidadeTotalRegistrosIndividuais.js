...
const GraficoQuantidadeTotalRegistrosIndividuais = props => {
  ...
  const obterDadosGrafico = useCallback(async () => {
    ...
    const retorno = await ServicoDashboardRegistroIndividual.obterQuantidadeTotalRegistrosIndividuais(
      anoLetivo,
...
GraficoQuantidadeTotalRegistrosIndividuais.propTypes = {
...
GraficoQuantidadeTotalRegistrosIndividuais.defaultProps = {
  anoLetivo: null,
  dreId: null,
  ueId: null,
  modalidade: null,
